"""SCM_PRODUCTION_CANDIDATE_JACKKNIFE_SENSITIVITY_IMPLEMENTATION_PLAN_001 validation harness."""
...
_ARTIFACT_ID = "SCM_PRODUCTION_CANDIDATE_JACKKNIFE_SENSITIVITY_IMPLEMENTATION_PLAN_001"
_ARTIFACT_VERSION = "1.0.0"
_VERDICT = "scm_production_candidate_jackknife_sensitivity_implementation_plan_defined_no_downstream_authorization"
_REPO = Path(__file__).resolve().parents[2]
_DEFAULT_SUMMARY = (
    _REPO
    / "docs/track_d/archives/SCM_PRODUCTION_CANDIDATE_JACKKNIFE_SENSITIVITY_IMPLEMENTATION_PLAN_001_summary.json"
)
...
_BOUNDARY_FLAGS = {
    ...
    "jackknife_sensitivity_not_implemented": True,
    "jackknife_not_auto_causal_ci_authorization": True,
    "jackknife_not_auto_p_value_authorization": True,
    "jackknife_diagnostic_sensitivity_only": True,
    "jackknife_conditioned_on_validation_and_null_calibration": True,
    ...
    "implementation_plan_only_no_jackknife_runtime": True,
    "downstream_work_paused": True,
}

INPUT_CONTRACT = "SCMJackknifeSensitivityInput"
...
INPUT_FIELDS = (
    ...
    "donor_weight_metadata",
    "treated_set_metadata",
...
EVIDENCE_FIELDS = (
    ...
    "unit_deletion_status",
    "donor_deletion_status",
    "treated_unit_deletion_status",
    "treated_set_sensitivity_status",
    "donor_weight_stability_status",
    "effect_instability_status",
    "influence_diagnostic_status",
    "high_leverage_unit_status",
    "effect_sign_stability_status",
    "effect_magnitude_stability_status",
    "sensitivity_threshold_status",
    "sensitivity_escalation_status",
    "causal_ci_boundary_status",
    "p_value_boundary_status",
...
SENSITIVITY_AREAS = (
    "jackknife_input_contract",
    "unit_deletion_contract",
    "donor_deletion_contract",
    "treated_unit_deletion_contract",
    "treated_set_sensitivity_contract",
    "donor_weight_stability_contract",
    "effect_instability_contract",
    "effect_scale_alignment",
    "estimand_alignment",
    "outcome_kpi_compatibility",
    "pre_period_fit_conditioning",
    "donor_support_conditioning",
    "null_calibration_dependency",
    "placebo_calibration_dependency",
    "jackknife_distribution_quality",
    "influence_diagnostic",
    "high_leverage_unit_detection",
    "donor_weight_concentration",
    "treated_unit_influence",
    "effect_sign_stability",
    "effect_magnitude_stability",
    "sensitivity_threshold_policy",
    "sensitivity_escalation_policy",
    "causal_ci_boundary",
    "p_value_boundary",
...
STAGES = (
    ...
    "stage_1_unit_deletion_contracts",
    "stage_2_donor_and_treated_set_sensitivity_contracts",
    "stage_3_donor_weight_and_influence_diagnostics",
    "stage_4_effect_instability_diagnostics",
    "stage_5_threshold_and_escalation_policy",
    "stage_6_null_calibration_and_validation_evidence_integration",
    "stage_7_dgp_and_failure_registry_integration",
...
NON_GOALS = (
    "no_jackknife_sensitivity_runtime",
    "no_jackknife_estimate_or_interval_computation",
    ...
    "no_automatic_causal_ci_from_jackknife_sensitivity",
    "no_automatic_p_value_from_jackknife_sensitivity",
)
...
AREA_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "unit_deletion_contract": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "unit_deletion_not_auto_causal_ci",
    },
    "donor_deletion_contract": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "donor_deletion_sensitivity_only",
    },
    "treated_unit_deletion_contract": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "treated_unit_deletion_sensitivity_only",
    },
    "treated_set_sensitivity_contract": {
    ...
    "donor_weight_stability_contract": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_VALIDATION_IMPLEMENTATION_001",),
        "planned_status": "candidate_after_validation",
        "boundary": "donor_weight_stability_gate",
    },
    "effect_instability_contract": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "effect_instability_diagnostic",
    },
    "effect_scale_alignment": {
    ...
    "pre_period_fit_conditioning": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_VALIDATION_IMPLEMENTATION_001",),
        "planned_status": "candidate_after_validation",
        "boundary": "pre_period_fit_required_before_jackknife",
    },
    "donor_support_conditioning": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_VALIDATION_IMPLEMENTATION_001",),
        "planned_status": "candidate_after_validation",
        "boundary": "donor_support_required_before_jackknife",
    },
    "null_calibration_dependency": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_NULL_CALIBRATION_IMPLEMENTATION_001",),
        "planned_status": "candidate_after_validation",
        "boundary": "null_calibration_precondition",
    },
    "placebo_calibration_dependency": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_NULL_CALIBRATION_IMPLEMENTATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "placebo_calibration_precondition",
    },
    "jackknife_distribution_quality": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "jackknife_distribution_diagnostic",
    },
    "influence_diagnostic": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "influence_diagnostic_only",
    },
    "high_leverage_unit_detection": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "high_leverage_warning_or_blocker",
    },
    "donor_weight_concentration": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_VALIDATION_IMPLEMENTATION_001",),
        "planned_status": "eligible_after_warning",
        "boundary": "weight_concentration_flagged",
    },
    "treated_unit_influence": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "treated_influence_diagnostic",
    },
    "effect_sign_stability": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "sign_stability_diagnostic",
    },
    "effect_magnitude_stability": {
        "artifacts": ("SCM_JACKKNIFE_CHARACTERIZATION_001",),
        "planned_status": "diagnostic_only",
        "boundary": "magnitude_stability_diagnostic",
    },
    "sensitivity_threshold_policy": {
        "artifacts": (_ARTIFACT_ID,),
        "planned_status": "candidate_after_validation",
        "boundary": "threshold_policy_not_authorization",
    },
    "sensitivity_escalation_policy": {
        "artifacts": (_ARTIFACT_ID,),
        "planned_status": "candidate_after_validation",
        "boundary": "escalation_policy_not_authorization",
    },
    "causal_ci_boundary": {
        "artifacts": ("SCM_AUGSYNTH_INFERENCE_PROMOTION_GATE_AUDIT_001",),
        "planned_status": "blocked",
        "boundary": "jackknife_not_causal_ci_authorization",
    },
    "p_value_boundary": {
        "artifacts": ("SCM_PRODUCTION_CANDIDATE_NULL_CALIBRATION_IMPLEMENTATION_001",),
        "planned_status": "blocked",
        "boundary": "jackknife_not_p_value_authorization",
    },
    "multiple_testing_boundary": {
    ...
    "release_gate_dependency": {
        ...
        "boundary": "release_gate_before_causal_ci_authorization",
    },
    "audit_reference_contract": {
        "artifacts": (_ARTIFACT_ID,),
        "planned_status": "candidate_after_validation",
    ...
    "production_authorization_boundary": {
        "artifacts": ("PRODUCTION_AUTHORIZATION_RELEASE_GATE_PLAN_001",),
        "planned_status": "blocked",
        "boundary": "no_production_authorization_from_jackknife",
    },
}
...
def _sensitivity_area_rows() -> list[SCMJackknifePlanRow]:
    rows: list[SCMJackknifePlanRow] = []
    for idx, area in enumerate(SENSITIVITY_AREAS, start=1):
        profile = AREA_PROFILES[area]
        rows.append(
            _row(
                f"JK-{idx:03d}",
                PlanSection.SENSITIVITY_AREA,
                area,
                f"Future SCM jackknife sensitivity implementation for {area}.",
                f"SCMJackknifeSensitivityInput fields relevant to {area}.",
                f"SCMJackknifeSensitivityEvidence status for {area}.",
...
def _input_contract_rows() -> list[SCMJackknifePlanRow]:
    rows: list[SCMJackknifePlanRow] = []
    for idx, field in enumerate(INPUT_FIELDS, start=1):
        rows.append(
            _row(
                ...
                field,
                f"Planned {INPUT_CONTRACT}.{field} for SCM jackknife sensitivity.",
                f"Typed {field} from SCM validation, null calibration, or governance state.",
                f"Validated {field} consumed by jackknife sensitivity harness.",
                f"{field} schema documented.",
                "no_jackknife_runtime",
...
def _evidence_contract_rows() -> list[SCMJackknifePlanRow]:
    rows: list[SCMJackknifePlanRow] = []
    for idx, field in enumerate(EVIDENCE_FIELDS, start=1):
        rows.append(
            _row(
                ...
                field,
                f"Planned {EVIDENCE_CONTRACT}.{field} output from jackknife sensitivity.",
                "SCM jackknife sensitivity area evaluation state.",
...
def _stage_rows() -> list[SCMJackknifePlanRow]:
    stage_purposes = {
        "stage_0_contract_and_registry": "Define SCMJackknifeSensitivityInput/Evidence schemas and area registry.",
        "stage_1_unit_deletion_contracts": "Unit, donor, and treated-unit deletion contracts.",
        "stage_2_donor_and_treated_set_sensitivity_contracts": "Donor and treated-set sensitivity contracts.",
        "stage_3_donor_weight_and_influence_diagnostics": "Donor weight stability and influence diagnostics.",
        "stage_4_effect_instability_diagnostics": "Effect sign/magnitude instability diagnostics.",
        "stage_5_threshold_and_escalation_policy": "Sensitivity threshold and escalation policy (not authorization).",
        "stage_6_null_calibration_and_validation_evidence_integration": "Consume SCMValidationEvidence and null calibration evidence.",
        "stage_7_dgp_and_failure_registry_integration": "DGP simulation and failure registry integration.",
        "stage_8_selector_shadow_integration": "Supply jackknife evidence to selector shadow mode.",
        ...
        for aspect in STAGE_ASPECTS:
            rows.append(
                _row(
                    ...
                    "Prior stage outputs and SCMJackknifeSensitivityInput subsets.",
                    f"Stage artifact for {stage}.",
                    f"{aspect} documented; scm_causal_confidence_interval_authorized remains false.",
...
def _non_goal_rows() -> list[SCMJackknifePlanRow]:
    rows: list[SCMJackknifePlanRow] = []
...
def build_scm_production_candidate_jackknife_sensitivity_implementation_plan() -> tuple[SCMJackknifePlanRow, ...]:
    """Return metadata-only SCM jackknife sensitivity implementation plan rows."""
    rows: list[SCMJackknifePlanRow] = []
    rows.extend(_sensitivity_area_rows())
...
def filter_scm_production_candidate_jackknife_sensitivity_implementation_plan(
    rows: tuple[SCMJackknifePlanRow, ...],
    *,
    plan_section: PlanSection | None = None,
    implementation_stage: str | None = None,
) -> tuple[SCMJackknifePlanRow, ...]:
    """Filter SCM jackknife sensitivity plan rows by optional criteria."""
    result: list[SCMJackknifePlanRow] = []
    for row in rows:
...
def validate_scm_production_candidate_jackknife_sensitivity_implementation_plan(
    rows: tuple[SCMJackknifePlanRow, ...],
) -> dict[str, Any]:
    """Validate SCM jackknife sensitivity plan registry thresholds and coverage."""
    issues: list[str] = []
    ...
    area_components = {r.field_or_component for r in rows if r.plan_section == PlanSection.SENSITIVITY_AREA}
    ...
    for area in SENSITIVITY_AREAS:
        if area not in area_components:
            issues.append(f"missing sensitivity_area: {area}")
    ...
    return {
        ...
        "sensitivity_area_count": len(area_components),
        "input_field_count": len(input_components),
        "evidence_field_count": len(evidence_components),
        "stage_counts": dict(stage_counts),
        "all_sensitivity_areas_covered": all(a in area_components for a in SENSITIVITY_AREAS),
...
def summarize_scm_production_candidate_jackknife_sensitivity_implementation_plan(
    rows: tuple[SCMJackknifePlanRow, ...],
) -> dict[str, Any]:
    """Serialize SCM jackknife sensitivity plan summary for archives."""
    validation = validate_scm_production_candidate_jackknife_sensitivity_implementation_plan(rows)
    area_statuses = {
        r.field_or_component: r.planned_status
        for r in rows
        if r.plan_section == PlanSection.SENSITIVITY_AREA
    }
    return {
        "artifact_id": _ARTIFACT_ID,
        "artifact_type": "scm_jackknife_sensitivity_implementation_plan_metadata_only",
        "status": "completed",
        "verdict": _VERDICT,
        ...
        "planned_sensitivity_areas": list(SENSITIVITY_AREAS),
        "sensitivity_area_planned_statuses": area_statuses,
        ...
        "all_sensitivity_areas_covered": validation["all_sensitivity_areas_covered"],
...
def build_scenarios() -> list[dict[str, Any]]:
    rows = build_scm_production_candidate_jackknife_sensitivity_implementation_plan()
    validation = validate_scm_production_candidate_jackknife_sensitivity_implementation_plan(rows)
    summary = summarize_scm_production_candidate_jackknife_sensitivity_implementation_plan(rows)
    ...
    for area in SENSITIVITY_AREAS:
        present = any(
            r.plan_section == PlanSection.SENSITIVITY_AREA and r.field_or_component == area for r in rows
        )
        scenarios.append(_scenario(f"sensitivity_area_{area}_defined", present))
    ...
    scenarios.append(_scenario(
        "recommended_next_artifact_jackknife_sensitivity_implementation",
        summary["next_artifact"] == RECOMMENDED_NEXT_ARTIFACTS[0],
    ))
    scenarios.append(_scenario(
        "jackknife_sensitivity_not_implemented",
        summary["jackknife_sensitivity_not_implemented"] is True,
    ))
    scenarios.append(_scenario(
    ...
    scenarios.append(_scenario(
        "implementation_plan_only_no_jackknife_runtime",
        summary["implementation_plan_only_no_jackknife_runtime"],
    ))
...
def run_validation(*, write_summary: bool = True, summary_path: Path | None = None) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "planned_sensitivity_areas": list(SENSITIVITY_AREAS),
        "sensitivity_area_planned_statuses": summary["sensitivity_area_planned_statuses"],
        "planned_input_contract": INPUT_CONTRACT,
        "planned_evidence_contract": EVIDENCE_CONTRACT,
        "planned_stages": list(STAGES),
        "dependencies_reconciled": list(DEPENDENCIES_RECONCILED),
