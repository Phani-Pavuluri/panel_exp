...
Six replicates per cell (modest MC). Synthetic worlds only. LOO empirical intervals diagnostic only. Canonical D5-STAT-SCM-JK-001 archive corrected separately in **`D5-STAT-SCM-JK-001-HARNESS-CORRECTION`**. JK conservatism vs LOO not fully characterized theoretically. Multi-treated aggregation semantics still merit INV-003 follow-up.
...
3. ✅ Fix D5-STAT-SCM-JK-001 harness assignment + truth scale — completed in **`D5-STAT-SCM-JK-001-HARNESS-CORRECTION`** (historical archive retained).
