...
|------------|---------|----------|-------------|---------------|
| **D1-FIND-001** | Geo runner null `pre_treatment_period` → full-panel matching risk | high | **characterization_required** (fix `61a174f`, D5 Jaccard 1.0) | Broader D5 OC; then D2 |
