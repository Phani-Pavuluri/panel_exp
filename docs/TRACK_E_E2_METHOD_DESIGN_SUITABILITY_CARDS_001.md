...
| **Conformal (D5-INST-AUGSYNTH-003 + INF-POSTFIX-001)** | **`restricted`** — F-INF-003 fixed orientation; POSTFIX null FPR 0 on battery; **not** governed uncertainty / not CalibrationSignal |
