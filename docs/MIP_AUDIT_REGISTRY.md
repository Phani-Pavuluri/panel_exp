...
| **P0-RECON-001** | 2026-07-18 | P0 governed-runtime state reconciliation | `ce0168f` | `p0_governed_runtime_hardening_state_reconciled_next_artifact_selected_no_authorization` | P0 lane substantially implemented; durable lifecycle, MIP envelope, evidence mapping, and multicell calibration remain open | `GEOX_MIP_GOVERNED_EXPERIMENT_ARTIFACT_ENVELOPE_AND_COMPATIBILITY_001` | **completed** |
