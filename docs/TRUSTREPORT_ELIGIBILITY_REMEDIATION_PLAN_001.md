...
**Follow-up artifact:** `D5-TRUST-DID-BOOTSTRAP-REMEDIATION-001`
...
**Follow-up artifact:** `D5-TRUST-TBRRIDGE-PLACEBO-001`

**Evaluate:** null-monitor calibration only; target class `null_monitor` or `diagnostic_only`.
