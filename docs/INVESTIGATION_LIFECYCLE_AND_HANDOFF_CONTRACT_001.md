...
- `INV-AUGSYNTH-JK-TRUSTREPORT-DISPOSITION-001` (RESOLVED — `FULL-TRUSTREPORT-ELIGIBILITY-REASSESSMENT-001`; DIAGNOSTIC_ONLY)
- `INV-SCM-PLACEBO-GOVERNED-SEMANTICS-001` (RESOLVED — `FULL-TRUSTREPORT-ELIGIBILITY-REASSESSMENT-001`; NULL_MONITOR_ONLY)
- `INV-MULTICELL-PERCELL-INFERENCE-001` (RESOLVED — `D5-TRUST-MULTICELL-PERCELL-INFERENCE-001`)
- `INV-MULTICELL-CELL-RELATIONSHIP-DECISION-POLICY-001` (RESOLVED — `MULTICELL-CELL-RELATIONSHIP-AND-DECISION-POLICY-CONTRACT-001`)
...
- `INV-STRATIFIED-SCM-JK-TRUSTREPORT-DISPOSITION-001` (RESOLVED — `D5-TRUST-STRATIFIED-SCM-JK-001`)
