...
Foundation and compatibility audits ✅
  ...
  → CALIBRATION_SIGNAL_SCHEMA_ALIGNMENT_DRAFT_001 (active method lane)
```
...
**Ordered next:** ✅ … → ✅ **`METHOD_READINESS_MATRIX_V2_001`** → ✅ **`CALIBRATION_SIGNAL_METHOD_GATE_DRAFT_001`** → **`CALIBRATION_SIGNAL_SCHEMA_ALIGNMENT_DRAFT_001`** → method-validation backlog.
