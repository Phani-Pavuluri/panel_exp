...
**Ordered next:** ✅ … → ✅ **`TBRRIDGE_PLACEBO_CALIBRATION_DIAGNOSTIC_CONTRACT_001`** → ✅ **`TBRRIDGE_PLACEBO_CALIBRATION_DIAGNOSTIC_RUNTIME_001`** → `TBRRIDGE_KFOLD_COVERAGE_VALIDATION_AUDIT_001`.
...
`TBRRIDGE_PLACEBO_CALIBRATION_DIAGNOSTIC_RUNTIME_001` implements manifest-driven placebo calibration diagnostics without placebo inference or uncertainty computation.

**Recommended immediate next:** `TBRRIDGE_KFOLD_COVERAGE_VALIDATION_AUDIT_001`

**Parallel:** `TBRRIDGE_KFOLD_COVERAGE_VALIDATION_AUDIT_001` · `SCM_UNIT_JACKKNIFE_PROMOTION_EVIDENCE_AUDIT_001`
...
| `TBRRIDGE_KFOLD_COVERAGE_VALIDATION_AUDIT_001` | next | KFold coverage validation audit |
