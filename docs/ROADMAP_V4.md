...
Foundation and compatibility audits ✅
  ...
  → SCM_STUDENTIZED_TREATED_SET_PLACEBO_INTEGRATION_001 (active method lane)
```
...
**Ordered next:** ✅ … → ✅ **`SCM_TREATED_SET_PLACEBO_INTEGRATION_001`** → ✅ **`STUDENTIZED_PLACEBO_RANK_INFERENCE_001`** → **`SCM_STUDENTIZED_TREATED_SET_PLACEBO_INTEGRATION_001`** → method-validation backlog.
