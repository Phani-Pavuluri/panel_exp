...
Foundation and compatibility audits ✅
  ...
  → METHOD_SPECIFIC_RANDOMIZATION_INFERENCE_VALIDATION_001 (active method lane)
```
...
**Ordered next:** ✅ … → ✅ **`MULTITREATED_TREATED_SET_PLACEBO_FRAMEWORK_001`** → ✅ **`SCM_PLACEBO_GOVERNED_SEMANTICS_001`** → **`METHOD_SPECIFIC_RANDOMIZATION_INFERENCE_VALIDATION_001`** → method-validation backlog.
