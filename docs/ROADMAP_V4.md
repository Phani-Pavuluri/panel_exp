...
**Recommended immediate next (Lane A):** `METHOD_PROMOTION_FRAMEWORK_APPLICATION_CHECKPOINT_001`
...
**Return to Lane A (active):** `METHOD_PROMOTION_FRAMEWORK_APPLICATION_CHECKPOINT_001` (SCM null-monitor review decision runtime complete)
...
| `METHOD_PROMOTION_FRAMEWORK_APPLICATION_CHECKPOINT_001` | next (Lane A) | Framework application checkpoint before AugSynth/DID |
