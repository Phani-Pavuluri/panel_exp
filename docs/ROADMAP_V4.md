...
**Recommended immediate next (Lane A):** `METHOD_PROMOTION_GENERIC_ADAPTER_MIP_HANDOFF_RUNTIME_001`
...
**Return to Lane A (active):** `METHOD_PROMOTION_GENERIC_ADAPTER_MIP_HANDOFF_RUNTIME_001` (MIP handoff contract defined)
...
| `METHOD_PROMOTION_GENERIC_ADAPTER_MIP_HANDOFF_RUNTIME_001` | next (Lane A) | Package-side MIP handoff builder/serializer |
