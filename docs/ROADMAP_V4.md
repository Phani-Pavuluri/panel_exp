...
**Recommended immediate next (Lane A):** `METHOD_PROMOTION_GENERIC_RUNTIME_001`
...
**Return to Lane A (active):** `METHOD_PROMOTION_GENERIC_RUNTIME_001` (generic runtime contract complete)
...
| `METHOD_PROMOTION_GENERIC_RUNTIME_001` | next (Lane A) | Generic runtime adapter (TBRRidge + SCM profiles) |
