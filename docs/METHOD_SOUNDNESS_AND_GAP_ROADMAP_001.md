...
**Active method lane (2026-06-03):** `DESIGN_AWARE_ASSIGNMENT_GENERATORS_001` → … → `AUGSYNTH_POINT_RANDOMIZATION_INTEGRATION_001` → `METHOD_READINESS_MATRIX_V2_001` ✅ → `CALIBRATION_SIGNAL_METHOD_GATE_DRAFT_001` per [`INFERENCE_REPLACEMENT_SCOUT_001`](audits/INFERENCE_REPLACEMENT_SCOUT_001.md).
