...
**Active method lane (2026-06-03):** `METHOD_ACCURACY_COMPATIBILITY_REFOCUS_AUDIT_001` → … → `SCM_PRODUCTION_CANDIDATE_JACKKNIFE_SENSITIVITY_IMPLEMENTATION_PLAN_001` ✅ → `SCM_PRODUCTION_CANDIDATE_JACKKNIFE_SENSITIVITY_IMPLEMENTATION_001` ✅ → **`SCM_PRODUCTION_CANDIDATE_RELEASE_GATE_REVIEW_PLAN_001`** (immediate next). Downstream schema/ingestion/decisioning paused.
