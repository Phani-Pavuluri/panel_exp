...
| **GAP-ASCM-MT-001** | design_compatibility | Multi-treated / per-cell compatibility needs explicit validation | W11 in ASCM-002; A28 placebo block | Pooled or wrong geometry claims | **DESIGN_READOUT_AUGSYNTH_COMPATIBILITY_001** | **P6** |
