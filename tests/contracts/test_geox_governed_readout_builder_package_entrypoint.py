...
from panel_exp.contracts.geox_governed_experiment_readout import build_example_geox_success_readout


def test_builder_preserves_readout_and_blocks_transport() -> None:
    readout = build_example_geox_success_readout()
    result, envelope = build_geox_governed_readout_package_entrypoint(readout)
