...
def test_normal_package_import_remains_authoritative():
    import panel_exp

    assert panel_exp.__file__.endswith("/panel_exp/__init__.py")
    assert panel_exp.BalancedRandomization is BalancedRandomization
    assert panel_exp.contracts.__file__.endswith("/panel_exp/contracts/__init__.py")
