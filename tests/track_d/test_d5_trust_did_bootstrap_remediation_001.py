...
class TestD5TrustDidBootstrapRemediation001:
    ...
    def test_interval_center_diagnostics(self, fast_payload: dict) -> None:
    ...
    def test_policy_comparisons_include_oracle(self, fast_payload: dict) -> None:
        assert "oracle_recentered_diagnostic" in fast_payload["policy_comparisons"]
    ...
    def test_harness_defect_documented(self, fast_payload: dict) -> None:
        assert fast_payload["bias_decomposition"]["harness_assignment_defect_confirmed"] is True
